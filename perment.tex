...
I believe that I could pursue my doctorate with the support of Global Korea Scholarship (GKS) in Korea. The reason is that university of korea have an advanced and comprehensive courses for architecture program. Another reason is that Korea as a country sucessfully develop its city and architecture.
For example, first, the success  transforamation of chunnam rver as public spaces attraction in city cnter. I learnt that in seminar in my second grade of undergraduate degree.
Second, the easy access of transportation in the city.
